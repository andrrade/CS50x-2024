...
void print_row(
    int spaces,
    int bricks) // passando os parâmetros 'qtde de espaços' e  'qtde de blocos' por linha;
{
...
void print_col(int height)
{ // tem como parâmetro a altura;
    for (int i = 0; i < height; i++)
    {
        int spaces = height - i - 1;
        print_row(spaces, i + 1);
        // fórmula para fazer a pirâmide invertida, ex: height = 4;
